...
public class AgentsProgressDataRefresher extends TimerTask {
    private Consumer<List<AgentProgressDataToTable>> updateAgentsProgressDataTable;
    private Consumer<AlliesTasksProgressToLabels> updateAlliesTasksProgressToLabels;

    public AgentsProgressDataRefresher(Consumer<List<AgentProgressDataToTable>> updateAgentsProgressDataTable, Consumer<AlliesTasksProgressToLabels> updateAlliesTasksProgressToLabels) {
        ...
        HttpClientUtil.runAsync(finalUrl, new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                if(response.isSuccessful()){
                    ...
                    Gson gson = new Gson();
                    List<AgentProgressDataToTable> agentProgressDataToTables = Arrays.asList(gson.fromJson(jsonAgentsProgressDataToTable, AgentProgressDataToTable[].class));
